                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_jenis_surat" id="nama_jenis_surat"
                            ...
                            required placeholder="Masukkan nama jenis surat" value="<?= old('nama_jenis_surat'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_jenis_surat" id="kode_jenis_surat"
                            ...
                            required placeholder="Masukkan kode jenis surat" value="<?= old('kode_jenis_surat'); ?>">
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <textarea name="ket_jenis_surat" id="ket_jenis_surat"
                            ...
                            required placeholder="Masukkan ket jenis surat"><?= old('ket_jenis_surat'); ?></textarea>
                        <div class="invalid-feedback">
